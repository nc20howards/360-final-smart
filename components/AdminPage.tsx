...
import { getAllModules, HOME_PAGE_MODULE_NAME, SMART_ADMISSION_MODULE_NAME, E_WALLET_MODULE_NAME, ONLINE_MODULE_NAME, SMART_STUDENT_ID_MODULE_NAME, E_CANTEEN_MODULE_NAME, NCHE_MODULE_NAME, STUDENT_TRANSFER_MODULE_NAME, MESSAGE_MODULE_NAME, EXPLORATION_MODULE_NAME, E_VOTE_MODULE_NAME, MY_INSTITUTE_MODULE_NAME } from '../services/moduleService';
            ...
            case 'headteacher':
                ...
                if (view === 'nche') {
                 ...
                 if (view === 'transfer_market') {
                    return <StudentTransferMarketplace school={schoolForHeadteacher} user={user} classes={classes} />;
                }
                if (view === 'messages') {
                ...
                if (view === 'online_feed') {
                    return <OnlineFeedPage 
                        ...
                        onNavigateToWallet={() => setView('e_wallet')}
                    />;
                }
                if (view === 'exploration') {
