...
import { School, Module, StudentTransferProposal, TransferNegotiation, GradingRubric, CompletedAdmission, NegotiationMessage, StudentTransferRequest } from '../types';
